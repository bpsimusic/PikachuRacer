...
/***/ function(module, exports, __webpack_require__) {
	...
	var render = function render() {
	  ...
	  if (Bird.pidgeys.length > 0) {
	    for (var _i = 0; _i < Bird.pidgeys.length; _i++) {
	      if (Collision.pidgeyBoxCollision(Pikachu.player.pos, Pikachu.player.boxSize, Bird.pidgeys[_i].pos, Bird.pidgeys[_i].boxSize)) {
	        return -1;
	      }
	    }
	  }
	  ...
	  if (Items.berries.length > 0) {
	    for (var _i2 = 0; _i2 < Items.berries.length; _i2++) {
	      var berry = Items.berries[_i2];
